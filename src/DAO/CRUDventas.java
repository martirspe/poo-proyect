...
//    }
    ...
    //Método que recibe un JTable y JLabel y muestra los registros de la tabla en el JTable
    public void MostrarProductosEnTabla(JTable tabla) {
        String[] titulo = {"Código", "Nombre", "Modelo", "Marca", "Categoría", "Cantidad", "Precio"};
        DefaultTableModel modelo = new DefaultTableModel(null, titulo);
        tabla.setModel(modelo);
    }
